            ...
            for (var j = 0; j < eventGrp.SoundEvents.Count; j++) {
                ...
                if (aEvent.isExpanded) {
                    ...
                    if (newEmit != aEvent.emitParticles) {
                        AudioUndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "toggle Emit Particle");
                    ...
                    if (aEvent.emitParticles) {
                        ...
                        if (newParticleCount != aEvent.particleCountToEmit) {
                            AudioUndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _sounds, "change Particle Count");
